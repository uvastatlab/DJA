---
title: "Data Wrangling Strategies with R"
author: "Clay Ford"
date: "Summer 2022"
...
- This allows the calculation of time spans.
- The `lubridate` package helps us parse dates and date-times as well as perform calculations and conversions of such values.
...
Note: data frames must have the same number of rows.
