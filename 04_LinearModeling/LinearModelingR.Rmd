...
R code needs to be in "chunks" in an R Markdown Notebook. Below is an example of an R code chunk. It makes a sin wave.
...
We could use our model estimates to generate data and see if they look similar to our original data. (Run entire chunk at once.) Feel free to repeatedly run the chunk to see different sets of model simulated data.
